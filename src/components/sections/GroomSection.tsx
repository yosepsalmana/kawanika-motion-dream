  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center py-20 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          className="absolute top-1/4 left-0 w-64 h-64 opacity-10"
          animate={{ rotate: -360 }}
          transition={{ duration: 60, repeat: Infinity, ease: 'linear' }}
        >
          <svg viewBox="0 0 200 200" className="w-full h-full text-sky-blue">
      ...
      >
        {/* The Groom label */}
        <motion.p
          className="text-sm tracking-[0.3em] uppercase text-gold-light mb-4"
        ...
        >
          ...
          <div className="absolute inset-8 rounded-full overflow-hidden bg-navy-medium border border-gold/30">
            <div className="w-full h-full bg-gradient-to-br from-sky-blue/10 to-gold/10 flex items-center justify-center">
              <span className="font-display text-6xl text-gold">R</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          "Bersama denganmu, setiap langkah menjadi perjalanan yang penuh makna dan kebahagiaan."
        </motion.p>
        ...
        >
          ...
          <span className="font-body">@rizki.pratama</span>
        </motion.a>
      </motion.div>

      {/* Floating decorative elements */}
      <motion.div
        className="absolute right-10 top-1/3 w-16 h-16 opacity-30"
